...
The QGIS project file (`cities_serbia.qgz`) is included in the repository and contains the configured layers and cartographic layout used to produce the final map.
